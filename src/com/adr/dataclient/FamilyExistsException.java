 ...
 * @author adrian
 */
public class FamilyExistsException extends IOException {

    /**
     * Creates a new instance of <code>FamilyExistsException</code> without detail message.
     */
    public FamilyExistsException() {
    }

    /**
     * Constructs an instance of <code>FamilyExistsException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public FamilyExistsException(String msg) {
        super(msg);
    }
}
