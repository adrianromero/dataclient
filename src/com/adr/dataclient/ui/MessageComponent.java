...
public class MessageComponent extends javax.swing.JPanel {
    ...
    public MessageComponent(String message, String description) {
        initComponents();
    ...
    /** Creates new form MessageComponent */
    public MessageComponent(String message, Exception description) {
        initComponents();

        jLabel1.setText(message);
        jTextArea1.setText(description.getClass().getName() + ":\n" + description.getLocalizedMessage());
        jTextArea1.setCaretPosition(0);
    }
